  ...
  return (
    <>
      ...
      <main className={montserrat.className} >
        ...
        <div style={{display: 'flex', flexDirection: 'row', backgroundColor: "var(--dark-blue)"}}>
          <a className='button' style={{marginRight: '50px', margin: "10px"}} href='https://docs.google.com/forms/d/e/1FAIpQLScGZmVAP0Ka_oGt7bhPkUmT7weW139NfeOHW-3ZYNTJT6SaPw/viewform'>Polgármesterjelölt vagyok, vállalást teszek!</a>
          <a className='button' style={{margin: "10px"}} href='/list'>Választó vagyok, megnézem a vállalásokat!</a>
